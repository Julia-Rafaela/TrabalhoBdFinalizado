...
public class ControllerCadastroParceiro {
	...
	public void addElemento(Tab tab) {
		...
		Button btncadas = new Button("Cadastrar");
		//Button btnEditar = new Button("Editar Cadastro");
		
		btncadas.setPrefWidth(75);
		...
		thelinha.getChildren().addAll( btncadas);
